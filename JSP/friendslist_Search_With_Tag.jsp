...
//-----
    ...
    String WhereDefault = "select * from friendslist where user_uSeqno = " + user_uSeqno + " and " + fTag + " = 1 and ";
    String where2 = "(fComment Like '%"+searchText+"%' or fName Like '%"+searchText+"%' or fTel Like '%"+searchText+"%' or fRelation Like '%"+searchText+"%' or fComment Like '%"+searchText+"%' or fAddress Like '%"+searchText+"%')";
    int count = 0;
